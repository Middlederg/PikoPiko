...
Cada jugador apila sus raciones a medida que las consigue. Solo la última ración conseguida está visible.
...
- O plantarse con la puntuación obtenida hasta ahora
...
Lanzamiento fallido:
- Cuando no pueda escoger ningúno de los valores de dados porque ese valor ya está guardado
